              ...
              <div className="space-y-8">
                {location.transitLegs.map((leg, idx) => (
                  <div key={idx} className="relative pl-12 last:pb-0">
                    ...
                    {/* Icon Circle */}
                    <div className={`absolute left-0 top-0 w-8 h-8 rounded-full bg-white border-2 flex items-center justify-center z-10 shadow-sm ${leg.type === 'bus' ? 'border-blue-500' : 'border-gray-200'
                      }`}>
